...
def analyze_eye_movement_pattern(l_cx, l_cy, r_cx, r_cy, img_w, img_h):
    ...
    if suspicious_movement:
        ...
        if suspicious_eye_movements > 10:  # Threshold for alert
            print(f"⚠️  SUSPICIOUS EYE MOVEMENT DETECTED: {movement_type} (Count: {suspicious_eye_movements})")
    ...
    while True:
        ...
        if key == ord('p'):
            ...
            if proctoring_enabled:
                print("Proctoring system ENABLED")
            else:
                print("Proctoring system DISABLED")
